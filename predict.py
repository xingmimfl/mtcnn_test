...
if __name__=="__main__":
    ...
    pnet.load_state_dict(torch.load("pnet/pnet_20190131_iter_1302000_.pth"))
    #pnet.load_state_dict(torch.load("/media/disk1/mengfanli/workplace/mtcnn_workplace/mtcnn_combining_dataloader/pnet/combining_dataloader_190131_iter_775000_.pth"))
    pnet.eval()
    ...
    onet = mtcnn.Onet()
    onet.load_state_dict(torch.load("onet/face_detect_0130_iter_995000_.pth"))
    onet.eval()
