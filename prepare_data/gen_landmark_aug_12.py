...
if __name__ == '__main__':
    dstdir = "/media/disk1/mengfanli/workplace/mtcnn_workplace/mtcnn_mfl/pnet/12/train_PNet_landmark_aug"
    OUTPUT = '/media/disk1/mengfanli/workplace/mtcnn_workplace/mtcnn_mfl/pnet/12'
